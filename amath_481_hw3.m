...
B = full(spdiags([adds adds subs subs], [Nx (-N + Nx) (N - Nx) -Nx], N, N));
A = full(two_d_lap_gen(10, 12, Nx, Ny));
...
A(1,:) = 0; A(1,1) = 1;
Tol = 1e-5 ; Options = odeset('RelTol',Tol,'AbsTol',Tol);
[t, wsol] = ode45('rhs', tspan, w0, [], N, v, A, B, C, Options);
% problem with passing parameters and options structure?
